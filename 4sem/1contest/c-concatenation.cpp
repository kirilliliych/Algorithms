...
std::string concatenation_228(std::vector<std::string> &words)
{
    ...
    for (size_t i = 1; i < words.size(); ++i)
    {
        ...
        std::string string_for_overlay_calculation = words[i] + SEPARATOR + answer.substr(cur_string_taken_suffix_start, cur_string_taken_suffix_size);
...
int main()
{
    ...
    std::cout << concatenation_228(input);
